...
clt = DBSCAN(metric="euclidean", n_jobs=2, min_samples=2, eps=0.40)
clt.fit(data)
    ...
    for labelID in labelIDs:
        if labelID > -1:
            ...
            for i in indices:
                ...
                faceFinal = cv2.putText(newFace, str(labelID), org=(left+5,bottom+30), 
                            fontFace=cv2.FONT_HERSHEY_SIMPLEX, fontScale=1, color=(0, 255, 66), thickness=2)
